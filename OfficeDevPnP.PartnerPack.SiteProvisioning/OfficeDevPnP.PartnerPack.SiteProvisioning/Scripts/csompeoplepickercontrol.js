...
(function (CAMControl) {
    var CsomPeoplePicker = (function () {
        ...
        // Property wrapped in function to allow access from event handler
        CsomPeoplePicker.prototype.GetServerDataMethod = function () {
            return this.ServerDataMethod;
        }

        // Property wrapped in function to allow access from event handler
        CsomPeoplePicker.prototype.GetSpHostUrl = function () {
            return this.SpHostUrl;
        }

        // Property wrapped in function to allow access from event handler
        CsomPeoplePicker.prototype.SetPrincipalType = function (principalType) {
        ...
        // Property wrapped in function to allow access from event handler
        CsomPeoplePicker.prototype.GetMinimalCharactersBeforeSearching = function () {
            return this.MinimalCharactersBeforeSearching;
        }

        // Property wrapped in function to allow access from event handler
        CsomPeoplePicker.prototype.SetMinimalCharactersBeforeSearching = function (minimalChars) {
        ...
        // HTML decoder
        CsomPeoplePicker.prototype.HtmlDecode = function (html) {
        ...
        CsomPeoplePicker.prototype.LoadScript = function (url, callback) {
        ...
        // String formatting 
        CsomPeoplePicker.prototype.Format = function (str) {
        ...
        CsomPeoplePicker.prototype.HideSelectionBox = function () {
            this.PeoplePickerDisplay.css('display', 'none');
        }

        // show the user selection box
        CsomPeoplePicker.prototype.ShowSelectionBox = function () {
            this.PeoplePickerDisplay.css('display', 'block');
        }

        // Generates the html for a resolved user
        CsomPeoplePicker.prototype.ConstructResolvedUserSpan = function (login, name) {
        ...
        CsomPeoplePicker.prototype.ResolvedUsersToHtml = function () {
            var userHtml = '';
        ...
        CsomPeoplePicker.prototype.ResolvedUser = function (login, name, email) {
            var user = new Object();
            user.Login = login;
            user.Name = name;
            user.Email = email;
        ...
        CsomPeoplePicker.prototype.PushResolvedUser = function (resolvedUser) {
        ...
        CsomPeoplePicker.prototype.RecipientSelected = function (login, name, email) {
        ...
        CsomPeoplePicker.prototype.DeleteProcessedUser = function (login) {
        ...
        // Initialize
        CsomPeoplePicker.prototype.Initialize = function () {

            var scriptUrl = "";
            var scriptRevision = "";
            $('script').each(function (i, el) {
                if (el.src.toLowerCase().indexOf('csompeoplepickercontrol.js') > -1) {
                    scriptUrl = el.src;
                        ...
                        if (searchText.length >= parent.GetMinimalCharactersBeforeSearching()) {
                            ...
                            $.ajax({
                                ...
                                success: function (jsonResponse) {
                                    parent.QuerySuccess(queryIDToPass, jsonResponse);
                                },
    ...
    CAMControl.CsomPeoplePicker = CsomPeoplePicker;
